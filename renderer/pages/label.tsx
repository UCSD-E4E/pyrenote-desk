					...
					<div>
						{showSpec && (
							<div key={wavesurfers[index].id} className={styles.waveContainer}>
								<div id={wavesurfers[index].id} style={{ width: '10000%', height: '420px', padding: '1px' }}></div>
								<div id={wavesurfers[index].spectrogramId} style={{ width: '100%', height: '50px', padding: '1px' }}></div>
